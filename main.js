...
const costsFlat = document.getElementById('costs-flat'),
      constFlatServices = document.getElementById('costs-house-services'),
...
const countingAvailableMoney = () => {
    ...
    const totalCosts = strToNum(costsFlat) + strToNum(constFlatServices) + strToNum(costsTransport) + strToNum(costsCredit)
